...
public class createBySimilarity {
    String artist;
    String title;
    public createBySimilarity(String artist, String title) {
        this.artist = artist;
        this.title = title;
    }
    ...
    public String createList(){
        ...
        if (query.hasMoreSolutions()) {
            Query instanceofQuery = new Query("key_and_bpm(" + this.title + "," + this.artist + ", Song, Artist).");
